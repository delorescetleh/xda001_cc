...
#define _4C_IICA_LOW_WIDTH                            (0x4CU) /* set the low-level width (tLOW) of the SCLA0 pin signal */
#define _55_IICA_HIGH_WIDTH                           (0x55U) /* set the high-level width of the SCLA0 pin signal */
