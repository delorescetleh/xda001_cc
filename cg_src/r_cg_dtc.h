...
#define _02_DTCD2_TRANSFER_BLOCKSIZE                 (0x02U) /* transfer block size */
...
#define _01_DTCD2_TRANSFER_BYTE                      (0x01U) /* number of transfers */
#define _01_DTCD3_TRANSFER_BYTE                      (0x01U) /* number of transfers */
#define _FF1E_DTCD0_SRC_ADDRESS                      (0xFF1EU) 
#define _FA00_DTCD1_SRC_ADDRESS                      (0xFA00U) 
#define _0454_DTCD2_SRC_ADDRESS                      (0x0454U) 
#define _0456_DTCD3_SRC_ADDRESS                      (0x0456U) 
#define _F900_DTCD0_DEST_ADDRESS                     (0xF900U) 
#define _FF31_DTCD1_DEST_ADDRESS                     (0xFF31U) 
#define _FB00_DTCD2_DEST_ADDRESS                     (0xFB00U) 
#define _FC00_DTCD3_DEST_ADDRESS                     (0xFC00U) 
